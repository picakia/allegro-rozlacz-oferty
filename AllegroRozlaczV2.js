      ...
      iframe.onload = () => {
        const checkReady = setInterval(() => {
          try {
            ...
            if (doc.querySelector('[data-role="search-form"]')) {
      ...
      clearBtn.addEventListener("click", () => {
        ...
        iframe.onload = () => {
          ...
          const checkReady = setInterval(() => {
            try {
              const doc = iframe.contentDocument || iframe.contentWindow?.document;
              if (doc && doc.querySelector('[data-role="search-form"]')) {
                clearInterval(checkReady);
...
zNode.innerHTML =
  ...
  '<button id="myButton" class="mgn2_14 mp0t_0a m9qz_yp mp7g_oh mse2_40 mqu1_40 mtsp_ib mli8_k4 mp4t_0 m3h2_0 mryx_0 munh_0 msbw_rf mldj_rf mtag_rf mm2b_rf msa3_z4 mqen_m6 meqh_en m0qj_5r msts_n7 mh36_16 mvrt_16 mg9e_0 mj7a_0 mjir_sv m2ha_2 m8qd_vz mjt1_n2 b1kk0 mgmw_u5g mrmn_qo mrhf_u8 m31c_kb m0ux_fp b1g6n mx7m_1 m911_co mefy_co mnyp_co mdwl_co mlkp_6x mqvr_g3 _1405b_ZtYZA"><span class="mpof_z0_s">Rozłącz te same oferty</span><span class="mpof_5r mpof_z0_s mpof_z0_m" style="display:none;">Rozłącz</span></button>';
// Mobile: show short label. Allegro uses mpof_z0_s (hide on small) / mpof_5r + show on small
(function injectMobileStyle() {
  const style = document.createElement("style");
  style.textContent = "@media(max-width:767px){#myButton .mpof_z0_s{display:none!important}#myButton span:last-child{display:inline!important}}";
